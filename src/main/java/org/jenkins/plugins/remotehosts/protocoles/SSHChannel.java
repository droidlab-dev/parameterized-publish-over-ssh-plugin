...
public class SSHChannel {
	...
	public static final Logger LOGGER = Logger.getLogger(SSHChannel.class.getName());

	public SSHChannel() {

	}

	public SSHChannel(String hostname, String port, String username, String password, String keyfile, String serverAliveInterval) {
